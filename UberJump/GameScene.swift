...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    private func createStarsAndPlatforms() {
        print("Creating stars and platforms | end Y: \(endLevelY)")
...
//       }
    ...
    private func removeAllStarsAndPlatforms() {
        foregroundNode.enumerateChildNodesWithName("NODE_PLATFORM", usingBlock: {
            (node, stop) in
